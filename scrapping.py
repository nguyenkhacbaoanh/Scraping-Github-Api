...
try:
   ...
   soup = BeautifulSoup(session.get("https://github.com/julioyildo").content, 'html.parser')
   try:
   ...
   soup = BeautifulSoup(session.get("https://github.com/julioyildo", params=params).content, 'html.parser')
   ...
   #it assumed that by now you are logged so we can now use .get and fetch any page of your choice
   star = BeautifulSoup(session.get("https://github.com/julioyildo", params=params).content, 'html.parser')
